...
public class LoggedDeepForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<LoggedDeepForestTrunkDecorator> CODEC = Codec.unit(LoggedDeepForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("logged_deep_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
