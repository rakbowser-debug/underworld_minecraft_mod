package net.mcreator.underworld.world.features.treedecorators;
...
public class LoggedDeepForestLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(LoggedDeepForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("logged_deep_forest_tree_leave_decorator", DECORATOR_TYPE));
	}

	public LoggedDeepForestLeaveDecorator() {
		super(0.25f);
	}
